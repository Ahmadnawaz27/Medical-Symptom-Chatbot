...
SYMPTOM_KEYWORDS = {
    ...
    "vomiting": ["vomiting", "vomit", "puking", "puke", "throwing up", "feel like vomiting",
        "feel like puking"],
    "fatigue": ["fatigue", "tired", "weak", "lazy", "worn out", "exhausted", "low energy"],
    "rash": ["rash", "red spots", "spots", "skin spots", "red bumps", "bumps", "skin bumps",
        "red lesions", "lesions", "skin lesions","red patches", "patches", "skin patches",
        "red marks", "marks", "skin marks", "red welts", "welts", "skin welts", "red hives", 
        "hives", "skin hives","skin redness", "red skin", "red patches", "patchy skin", 
        "skin inflammation", "inflamed skin", "skin irritation"],
    "itching": ["itching", "itchy", "scratch", "scratching", "skin itch", "skin is itchy", 
        "itchy skin", "itchy rash", "rash is itchy", "itchy spots", "spots are itchy", "itchy bumps", 
        "bumps are itchy", "itchy lesions", "lesions are itchy", "itchy patches", "patches are itchy"],
    "blocked_nose": ["blocked nose", "stuffy nose", "nose blocked", "nasal congestion"],
    "runny_nose": ["runny nose" , "running nose", "nose running", "nasal discharge", "nasal drip", 
        "nose discharge", "nose drip", "nose is running"],
    "cough": ["cough", "coughing"],
    "breathing_difficulty": ["breathing difficulty", "difficulty breathing", "can't breathe", 
        "cannot breathe", "breath normally"],
    ...
    "frequent_urination": ["frequent urination", "urinating often", "pee often", "urinating frequently",
        "pee frequently", "frequent urination", "frequent peeing", "frequent urination", "frequent peeing", 
        "urinating frequently", "urinating often", "pee often", "pee frequently", "more frequent urination",
        "more frequent peeing", "urinating more often", "peeing more often", "urinating more frequently", 
